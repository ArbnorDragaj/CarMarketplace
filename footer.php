<footer class="site-footer">
    <div class="footer-inner">
        ...
        <div class="footer-brand">
            <h3 class="footer-brand-name">CarMarketPlace</h3>

            <p class="footer-tagline">
                Gjej makinën ideale me çmime të mira, informata të qarta dhe përzgjedhje të sigurt.
            </p>

            <p class="footer-follow-title">Na ndiqni</p>

            <div class="footer-socials">
                <a href="https://www.facebook.com/login.php" target="_blank" class="footer-social" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/accounts/login/" target="_blank" class="footer-social" aria-label="Instagram">
                ...
                <a href="https://twitter.com/login" target="_blank" class="footer-social" aria-label="Twitter">
        ...
        <div class="footer-column">
            <h4 class="footer-heading">Linkat</h4>
        ...
        <div class="footer-column">
            <h4 class="footer-heading">Kontakti</h4>
            <ul class="footer-list footer-contact">
                <li><a href="tel:+38345123123">+383 45 123 123</a></li>
                <li><a href="mailto:carmarketplace@gmail.com">carmarketplace@gmail.com</a></li>
    ...
    <div class="footer-bottom">
        <p>© <?php echo date("Y"); ?> CarMarketPlace. Të gjitha të drejtat e rezervuara.</p>
    </div>
</footer>